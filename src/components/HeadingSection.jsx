export default function HeadingSection({ cinematicMode, onFeelPride }) {
  return (
    ...
    >
      ...
      <div className="animate-fadeInUp delay-600 opacity-0">
        <h1
          ...
          style={{
            ...
            lineHeight: 1.04,
            textShadow: '0 4px 24px rgba(0,0,0,0.85), 0 1px 8px rgba(0,0,0,0.5)',
          }}
        >
          मेरा भारत
        </h1>
      ...
      >
        <div style={{ width: '40px', height: '1px', background: 'linear-gradient(to left, rgba(255,153,51,0.65), transparent)' }} />
        <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'rgba(255,153,51,0.85)', boxShadow: '0 0 10px rgba(255,153,51,0.7)' }} />
      </div>
      ...
      <div className="animate-fadeIn delay-1200 opacity-0">
        <p
          ...
          style={{
            ...
            textShadow: '0 3px 15px rgba(0,0,0,0.9), 0 1px 4px rgba(0,0,0,0.6)',
          }}
        >
